...
function Section1({ content }) {
  ...
  return (
    <div className="section1">
      ...
      <h1>Voici quelques informations (et indices) concernant les règles du jeu et son fonctionnement &#x1F476; :</h1>
      <ul>
      ...
      <li>Et enfin la date de naissance, tu dois également deviner l'heure ! (début de grossesse estimée au 19 Juillet) &#x23F0;</li>
